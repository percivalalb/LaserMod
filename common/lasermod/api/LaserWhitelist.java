...
/**
 * @author ProPercivalalb If you block should allow a laser to pass through it
 *         e.g. like tall grass please register you blocks here.
 */
public class LaserWhitelist {
	...
	public static boolean canLaserPassThrought(World world, int x, int y, int z) {
		...
		return canLaserPassThrought(world.getBlockId(x, y, z),
	 ...
	 * 
	 * @param blockId
	 *            The blockId of the target location
	 * @param blockMeta
	 *            The blockMeta of the target location
