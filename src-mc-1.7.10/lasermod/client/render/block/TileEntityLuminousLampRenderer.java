...
public class TileEntityLuminousLampRenderer extends TileEntitySpecialRenderer {
    ...
    public void renderLuminousPanel(TileEntityLuminousLamp panel, double x, double y, double z, float tick) {
    	LaserInGame laser = panel.getCombinedOutputLaser(ForgeDirection.UNKNOWN);
    	...
    	LaserCollisionBoxes.addLaserCollision(new LaserToRender(laser, panelOutline, x, y, z, panel.xCoord, panel.yCoord, panel.zCoord, ForgeDirection.UNKNOWN, 0.7F, false));
