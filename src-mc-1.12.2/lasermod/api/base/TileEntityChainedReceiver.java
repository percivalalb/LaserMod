 ...
 */
public abstract class TileEntityChainedReceiver extends TileEntityLaserDevice implements ILaserReceiver {
	...
	public void tickLaserLogic() {
		if(!this.noLaserInputs()) {
			...
			for(EnumFacing dir : this.getInputDirections())
				if(!LaserUtil.isValidSourceOfPowerOnSide(this, dir))
	...
	protected abstract void onLaserRemoved();

	protected abstract void sendUpdateDescription();
